            ...
            try {
                ...
                switch (serviceCommand) {
                    ...
                    case MEASURE_DELAY:
                        ...
                        break;
                    case QUERY_STATE:
                        if (staticsBroadCastService != null) {
                            staticsBroadCastService.sendBroadCast(V2rayProxyService.this, new StateListener() {
                                @Override
        ...
        try {
            ...
            switch (serviceCommand) {
                ...
                case START_SERVICE:
                    ...
                    if (currentConfig == null || currentConfig.fullJsonConfig == null) {
                        stopService();
                        break;
                    }
