...
object Utils {
    ...
    fun getClipboard(context: Context): String {
        return try {
            ...
            Log.e(Constants.TAG, "Failed to get clipboard content", e)
            ""
        }
    }
    ...
    fun setClipboard(context: Context, content: String) {
        try {
            ...
            Log.e(Constants.TAG, "Failed to set clipboard content", e)
        }
    }
    ...
    fun openUri(context: Context, uriString: String) {
        try {
            ...
            Log.e(Constants.TAG, "Failed to open URI", e)
        }
    }
    ...
    fun getUuid(): String {
        return try {
            ...
            Log.e(Constants.TAG, "Failed to generate UUID", e)
            ""
        }
    }
    ...
    fun decodeURIComponent(url: String): String {
        return try {
            ...
            Log.e(Constants.TAG, "Failed to decode encodeURIComponent", e)
            url
        }
    }
    ...
    fun encodeURIComponent(url: String): String {
        return try {
            ...
            Log.e(Constants.TAG, "Failed to encode encodeURIComponent", e)
            url
        }
    }
    ...
    fun isIpInCidr(ip: String, cidr: String): Boolean {
        try {
            ...
            Log.e(Constants.TAG, "Failed to check if IP is in CIDR", e)
            return false
        }
    }
    ...
    fun formatTimestamp(
        ...
        return try {
            ...
            Log.e(Constants.TAG, "Failed to format timestamp", e)
            ""
        }
    }
}